...
public class AddCustomer extends JFrame{
    ...
    public AddCustomer(String username) throws SQLException {
        ...
        r2.setBounds(350,230,80,12);
        add(r2);
        
        JLabel lblCountry = new JLabel("COuntry ");
        lblCountry.setBounds(35,190,200,14);
        contentPane.add(lblCountry);
        
        t3=new JTextField();
        t3.setBounds(271,150,200,14);
        contentPane.add(t3);
        t3.setColumns(10);
        ...
        t5=new JTextField();
        t5.setBounds(271,150,200,14);
        contentPane.add(t5);
        t5.setColumns(10);
        
        JLabel lblCheckInStatus= new JLabel("Phone : ");
        lblCheckInStatus.setBounds(35,190,200,14);
        contentPane.add(lblCheckInStatus);
        
        t6=new JTextField();
        t6.setBounds(271,150,200,14);
        contentPane.add(t6);
        t6.setColumns(10);
