...
public class Signup extends JFrame implements ActionListener {
    ...
    public Signup() {
        ...
        comboBox.setModel(new DefaultComboBoxModel(new String[]{"your nickname?", "your lucky number","your fav superhero","your childhood name"}));
