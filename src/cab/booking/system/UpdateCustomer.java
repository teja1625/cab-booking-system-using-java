...
public class UpdateCustomer extends JFrame {
    ...
    JLabel lblReservationRoomNumber = new JLabel("Permanant address:");
    lblReservationRoomNumber.setBounds(35,110,200,14);
    contentPane.add(lblReservationRoomNumber);
           ...
           String s6=t6.getText();
            String s7=t7.getText();
             String s8=t8.getText();
              ...
              String q1="update customer set id_type= '"+s2+"',number='"+s3+"',name='"+s4+"',gender='"+s5+"',country='"+s6+"',permanantaddress='"+s7+"',phone='"+s8+"',email='"+s9+"' ";
